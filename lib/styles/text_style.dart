...
// var smallText = const TextStyle();
// var mediumText = const TextStyle(fontWeight: FontWeight.w500);
...
var appBarStyle = GoogleFonts.dmSans(fontSize: 20.sp, color: goSmartBlue, fontWeight: FontWeight.w700);
